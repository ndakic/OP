...
public class Invoice {
	...
	public Invoice(Integer invoice, String date, Person billTo, Person shipTo,
	...
	public String toString() {
		return "Invoice [invoice=" + invoice + ", date=" + date + ", billTo="
				+ billTo + ", shipTo=" + shipTo + ", product=" + product
				+ ", tax=" + tax + ", total=" + total + ", comments="
				+ comments + "]";
	}
